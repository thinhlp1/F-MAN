...
public class CheckoutController {
    ...
    public ResponseEntity<PaymentReponse> createPayment(@RequestBody PaymentRquest paymentRequestDTO) throws UnsupportedEncodingException {
        ...
        return ResponseEntity.ok(paymentReponseDTO);
