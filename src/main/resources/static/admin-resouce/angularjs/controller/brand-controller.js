app.controller(
  ...
  function (
    ...
    const BRAND_URL = "http://localhost:8080/admin/brands";
    const BRAND_LIST_URL = `${BRAND_URL}/list`;
    ...
    $scope.edit = async (id) => {
      ...
      try {
        const resp = await $http.get(BRAND_URL + "/" + id);
