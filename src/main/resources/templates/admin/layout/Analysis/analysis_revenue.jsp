    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
                ...
                <div id="container" class="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row d-flex">
                            <div class=" col-2">
                                <a type="button" href="/admin/analysis/revenue" class="btn btn-blue-primary">Thống kê
                                    doanh thu</a>
                            </div>
                            <div class="col-2">
                                <a href="/admin/analysis/sellProducts" class="btn btn-blue-primary">Thống kê sản
                                    phẩm</a>
                            </div>
                            <div class="col-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="sort" id="sortOrder">
                                        ...
                                        <c:forEach items="${listYear}" var="year">
                                            <li><a class="dropdown-item" value="${year}" type="button"
                                                href="/admin/analysis/revenue?year=${year}" >${year}</a>
                                         </li>
                                        </c:forEach>
            ...
            <script>
                ...
                <c:forEach items="${dataRevenueByMonths}" var="data">
                    listData.push(${data})
                </c:forEach>
