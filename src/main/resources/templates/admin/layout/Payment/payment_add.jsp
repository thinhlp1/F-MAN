<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <head>
      ...
      <title>FMan | Create Payment</title>
      ...
      <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div id="container" class="page-wrapper">
          ...
          <div class="container-fluid">
            <!--      CODE TRONG DDAAY-->
            <div class="back mb-3">
              <a class="btn btn-blue-primary" href="${pageContext.request.contextPath}/admin/payments/">
                <i class="fa fa-chevron-circle-left" aria-hidden="true"></i>
                Quay lại
              </a>
            </div>
            <form:form action="${pageContext.request.contextPath}/admin/payments/create" modelAttribute="payment"
              method="post" enctype="multipart/form-data">
              <div class="row">
                <div id="imgDialog" class="col-4 mb-3">
                  <span class="text-danger fst-italic fw-bold">${message_img}</span>
                ...
                <div class="col-8">
                  <span class="text-danger fst-italic fw-bold">${messageId}</span>
                  <form:errors class="text-danger fst-italic fw-bold" path="id" />
                  <div class="row">
                    <div class="col-12">
                      <div class="form-floating mb-3">
                        <div class="form-floating mb-3">
                          <form:input type="text" class="form-control" id="payment_id"
                            placeholder="Có thể điền ký tự hoặc số" path="id" />
                          <label for="payment_id">Nhập tên ID</label>
                        </div>
                      </div>
                    </div>
                    <span class="text-danger fst-italic fw-bold">${messageName}</span>
                    <form:errors class="text-danger fst-italic fw-bold" path="name" />
                    <div class="col-12">
                      <div class="form-floating mb-3">
                        <form:input type="text" class="form-control" id="payment_name"
                          placeholder="Tên phương thức thanh toán" path="name" />
                        <label for="payment_name">Tên phương thức thanh toán</label>
                      </div>
                    </div>
                    <span class="text-danger fst-italic fw-bold">${messageAccountNumber}</span>
                    <form:errors class="text-danger fst-italic fw-bold" path="account_number" />
                    <div class="col-12">
                      <div class="form-floating mb-3">
                        <form:input type="text" class="form-control" id="card_number" placeholder="Số tài khoản"
                          path="account_number" />
                    ...
                    <div class="col-12">
                      ...
                      <div class="form-check form-switch ms-3">
                        <form:checkbox class="form-check-input" id="active" path="active" value="1" checked="checked" />
