...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
        ...
        <title>FMan | Đơn hàng cần duyệt</title>
    ...
    <body>
                        ...
                        <div class="d-flex justify-content-center pagination-custom">
                            <ul class="pagination">
                                ...
                                <c:forEach var="i" begin="0" end="${totalPages - 1 < 0 ? 0 : totalPages - 1}">
                                    <li  class="page-item"><a id="page_${i + 1}" name="${(i == currentPage) ? 'page_active' : 'no'}" class="${(i == currentPage) ? 'active' : 'no'} page-link fs-4 " type="button" onclick="pagination(this)">${i + 1}</a></li>
                                </c:forEach>
        ...
        <script>
            ...
            function filtOrder() {
                ...
                var url = "${pageContext.request.contextPath}/admin/orders/approve?orderStateId=PENDING_APPROVAL" + "&sortBy="+ sortBy +"&sortOrder="+sortOrder+"&page="+(page)+"&size=" +pageSize
