    ...
    <div id="container" class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="back mb-3">
               ...
               <!-- Form xử lý -->
                    <form:form action="${pageContext.request.contextPath}/admin/products/update-form/${product.id}" method="post" modelAttribute="product" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div id="imgDialog" class="col-4 mb-3">
                            <div id="image-box" class="text-center position-relative w-100 h-100"
                                style="border: dashed">
                                <img id="blah" class="img-fluid w-100 h-100" alt="" src="${pageContext.request.contextPath}/views/admin/plugins/images/${product.image}">
                        ...
                        <div class="col-8">
                            <div class="row">
                              <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <form:input type="text" class="form-control" readonly="true" path="id" id="product_id"
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <form:input type="text" path="price" class="form-control" id="product_price"
                           ...
                           <!-- start modal -->     
                                <div class="col-6">
                                    <button type="button" id="loadingSizeProduct" class="btn btn-outline-dark w-100 h-75" data-bs-toggle="modal"
                                                            ...
                                                            <table id="my-table"
                                                                ...
                                                                <tbody>
                                                               	<c:forEach var="item" items="${listProductSize}">
                                                                    <tr>
                                                                        <td>
                                                                        <input class="h-100 w-100 py-2 fs-4"
                                                                                type="text" value="${item.size.id}" name="size_product" placeholder="Nhập size">
                                            
                                                                        </td>
                                                                        <td>
                                                                        <input class="h-100 w-100 py-2 fs-4" name="quatity_product"
                                                                                type="number"
                                    ...
                                    <script>
                                        ...
                                        const loadingSizeProduct = document.getElementById("loadingSizeProduct");
                                        ...
                                        clickSize.addEventListener('click' , function() {
                                            ...
                                            $.ajax({
					                            url: "${pageContext.request.contextPath}/admin/products/update/productsize",
					                            type: "POST",
