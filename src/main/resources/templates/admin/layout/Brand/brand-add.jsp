        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div id="container" class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form:form action="${pageContext.request.contextPath}/admin/brands/create" method="post" modelAttribute="brand"  enctype="multipart/form-data">
                    <div class="row">
                        <div id="imgDialog" class="col-4 mb-3">
                            <div id="image-box" class="text-center position-relative w-100 h-100"
                                style="border: dashed">
                                <img id="blah" class="img-fluid" style="max-height: 300px">
                                <i id="icon-upload"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <form:input class="form-control" path="id" id="id_brand"
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-floating mb-3">
                                        <form:input class="form-control" path="name" id="name_brand"
