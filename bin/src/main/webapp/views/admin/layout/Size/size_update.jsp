        ...
        <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div id="container" class="page-wrapper">
                ...
                <div class="container-fluid">
                    <!--      CODE TRONG DDAAY-->
                    <div class="back mb-3">
                        <a class="btn btn-blue-primary" href="size_list.html">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="size_dai"
                                                placeholder="Nhập chiều dài">
                                            <label for="user_account">Chiều dài</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="size_rong"
                                                placeholder="Nhập chiều rộng">
                                            <label for="user_password">Chiều rộng</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
